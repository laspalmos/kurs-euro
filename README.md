...
- polskie święta ustawowe (ustawa z 18.01.1951 o dniach wolnych od pracy)
...
```
0 8 * * 1-5 /usr/bin/python3 /home/lubapl/claude-prj/kurs-euro/pobierz_kursy.py >> /home/lubapl/claude-prj/kurs-euro/kursy_nbp.log 2>&1
```
